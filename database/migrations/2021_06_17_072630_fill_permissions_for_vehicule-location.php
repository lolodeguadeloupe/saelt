...
class FillPermissionsForVehiculeLocation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVehiculeLocation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.vehicule-location',
            'admin.vehicule-location.index',
            'admin.vehicule-location.create',
            'admin.vehicule-location.show',
            'admin.vehicule-location.edit',
            'admin.vehicule-location.delete',
            'admin.vehicule-location.bulk-delete',
            'admin.vehicule-location.update-prestataire',
            'admin.vehicule-location.store-prestataire'
        ]);
