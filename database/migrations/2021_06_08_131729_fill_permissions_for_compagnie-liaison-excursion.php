...
class FillPermissionsForCompagnieLiaisonExcursion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCompagnieLiaisonExcursion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.compagnie-liaison-excursion',
            'admin.compagnie-liaison-excursion.index',
            'admin.compagnie-liaison-excursion.create',
            'admin.compagnie-liaison-excursion.show',
            'admin.compagnie-liaison-excursion.edit',
            'admin.compagnie-liaison-excursion.delete',
            'admin.compagnie-liaison-excursion.bulk-delete',
        ]);
