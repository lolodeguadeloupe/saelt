...
class FillPermissionsForExcursion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForExcursion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.excursion',
            'admin.excursion.index',
            'admin.excursion.create',
            'admin.excursion.show',
            'admin.excursion.edit',
            'admin.excursion.delete',
            'admin.excursion.bulk-delete',
            'admin.excursion.create-prestataire',
            'admin.excursion.update-prestataire',
            'admin.excursion.strore-prestataire',
        ]);
