...
class FillPermissionsForBilleterieMaritime extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBilleterieMaritime constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.billeterie-maritime',
            'admin.billeterie-maritime.index',
            'admin.billeterie-maritime.create',
            'admin.billeterie-maritime.show',
            'admin.billeterie-maritime.edit',
            'admin.billeterie-maritime.delete',
            'admin.billeterie-maritime.bulk-delete',
        ]);
