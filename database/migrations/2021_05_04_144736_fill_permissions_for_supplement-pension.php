...
class FillPermissionsForSupplementPension extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSupplementPension constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.supplement-pension',
            'admin.supplement-pension.index',
            'admin.supplement-pension.create',
            'admin.supplement-pension.show',
            'admin.supplement-pension.edit',
            'admin.supplement-pension.delete',
            'admin.supplement-pension.bulk-delete',
        ]);
