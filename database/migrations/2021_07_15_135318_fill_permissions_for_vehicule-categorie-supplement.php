...
class FillPermissionsForVehiculeCategorieSupplement extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVehiculeCategorieSupplement constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.vehicule-categorie-supplement',
            'admin.vehicule-categorie-supplement.index',
            'admin.vehicule-categorie-supplement.create',
            'admin.vehicule-categorie-supplement.create-all',
            'admin.vehicule-categorie-supplement.show',
            'admin.vehicule-categorie-supplement.edit',
            'admin.vehicule-categorie-supplement.delete',
            'admin.vehicule-categorie-supplement.bulk-delete',
        ]);
