...
class FillPermissionsForServicePort extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForServicePort constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.service-port',
            'admin.service-port.index',
            'admin.service-port.create',
            'admin.service-port.show',
            'admin.service-port.edit',
            'admin.service-port.delete',
            'admin.service-port.bulk-delete',
        ]);
