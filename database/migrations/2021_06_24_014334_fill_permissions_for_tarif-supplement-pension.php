...
class FillPermissionsForTarifSupplementPension extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTarifSupplementPension constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tarif-supplement-pension',
            'admin.tarif-supplement-pension.index',
            'admin.tarif-supplement-pension.create',
            'admin.tarif-supplement-pension.show',
            'admin.tarif-supplement-pension.edit',
            'admin.tarif-supplement-pension.delete',
            'admin.tarif-supplement-pension.bulk-delete',
        ]);
