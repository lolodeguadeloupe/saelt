...
class FillPermissionsForItineraireDescriptionExcursion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForItineraireDescriptionExcursion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.itineraire-description-excursion',
            'admin.itineraire-description-excursion.index',
            'admin.itineraire-description-excursion.create',
            'admin.itineraire-description-excursion.show',
            'admin.itineraire-description-excursion.edit',
            'admin.itineraire-description-excursion.delete',
            'admin.itineraire-description-excursion.bulk-delete',
        ]);
