...
class FillPermissionsForServiceAeroport extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForServiceAeroport constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.service-aeroport',
            'admin.service-aeroport.index',
            'admin.service-aeroport.create',
            'admin.service-aeroport.show',
            'admin.service-aeroport.edit',
            'admin.service-aeroport.delete',
            'admin.service-aeroport.bulk-delete',
        ]);
