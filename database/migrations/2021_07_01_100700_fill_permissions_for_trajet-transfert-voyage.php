...
class FillPermissionsForTrajetTransfertVoyage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTrajetTransfertVoyage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.trajet-transfert-voyage',
            'admin.trajet-transfert-voyage.index',
            'admin.trajet-transfert-voyage.create',
            'admin.trajet-transfert-voyage.show',
            'admin.trajet-transfert-voyage.edit',
            'admin.trajet-transfert-voyage.delete',
            'admin.trajet-transfert-voyage.bulk-delete',
        ]);
