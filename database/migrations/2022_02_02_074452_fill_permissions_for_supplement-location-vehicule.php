...
class FillPermissionsForSupplementLocationVehicule extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSupplementLocationVehicule constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.supplement-location-vehicule',
            'admin.supplement-location-vehicule.index',
            'admin.supplement-location-vehicule.create',
            'admin.supplement-location-vehicule.show',
            'admin.supplement-location-vehicule.edit',
            'admin.supplement-location-vehicule.delete',
            'admin.supplement-location-vehicule.bulk-delete',
        ]);
