...
class FillPermissionsForVehiculeTransfertVoyage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVehiculeTransfertVoyage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.vehicule-transfert-voyage',
            'admin.vehicule-transfert-voyage.index',
            'admin.vehicule-transfert-voyage.create',
            'admin.vehicule-transfert-voyage.show',
            'admin.vehicule-transfert-voyage.edit',
            'admin.vehicule-transfert-voyage.delete',
            'admin.vehicule-transfert-voyage.bulk-delete',
            'admin.vehicule-transfert-voyage.update-prestataire',
            'admin.vehicule-transfert-voyage.store-prestataire'
        ]);
