...
class FillPermissionsForLigneCommande extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLigneCommande constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ligne-commande',
            'admin.ligne-commande.index',
            'admin.ligne-commande.create',
            'admin.ligne-commande.show',
            'admin.ligne-commande.edit',
            'admin.ligne-commande.delete',
            'admin.ligne-commande.bulk-delete',
        ]);
