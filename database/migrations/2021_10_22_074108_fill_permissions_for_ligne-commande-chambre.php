...
class FillPermissionsForLigneCommandeChambre extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLigneCommandeChambre constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ligne-commande-chambre',
            'admin.ligne-commande-chambre.index',
            'admin.ligne-commande-chambre.create',
            'admin.ligne-commande-chambre.show',
            'admin.ligne-commande-chambre.edit',
            'admin.ligne-commande-chambre.delete',
            'admin.ligne-commande-chambre.bulk-delete',
        ]);
