...
class FillPermissionsForMediaImageUpload extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMediaImageUpload constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.media-image-upload.index',
            'admin.media-image-upload.create',
            'admin.media-image-upload.show',
            'admin.media-image-upload.edit',
            'admin.media-image-upload.delete',
            'admin.media-image-upload.bulk-delete',
        ]);
