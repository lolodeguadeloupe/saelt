...
class FillPermissionsForConducteurSupplemetaireLocationVehicule extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForConducteurSupplemetaireLocationVehicule constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.conducteur-supplemetaire-location-vehicule',
            'admin.conducteur-supplemetaire-location-vehicule.index',
            'admin.conducteur-supplemetaire-location-vehicule.create',
            'admin.conducteur-supplemetaire-location-vehicule.show',
            'admin.conducteur-supplemetaire-location-vehicule.edit',
            'admin.conducteur-supplemetaire-location-vehicule.delete',
            'admin.conducteur-supplemetaire-location-vehicule.bulk-delete',
        ]);
