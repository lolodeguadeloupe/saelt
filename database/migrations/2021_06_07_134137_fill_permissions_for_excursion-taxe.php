...
class FillPermissionsForExcursionTaxe extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForExcursionTaxe constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.excursion-taxe',
            'admin.excursion-taxe.index',
            'admin.excursion-taxe.create',
            'admin.excursion-taxe.show',
            'admin.excursion-taxe.edit',
            'admin.excursion-taxe.delete',
            'admin.excursion-taxe.bulk-delete',
        ]);
