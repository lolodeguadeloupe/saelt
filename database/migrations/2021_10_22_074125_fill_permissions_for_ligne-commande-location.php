...
class FillPermissionsForLigneCommandeLocation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLigneCommandeLocation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ligne-commande-location',
            'admin.ligne-commande-location.index',
            'admin.ligne-commande-location.create',
            'admin.ligne-commande-location.show',
            'admin.ligne-commande-location.edit',
            'admin.ligne-commande-location.delete',
            'admin.ligne-commande-location.bulk-delete',
        ]);
