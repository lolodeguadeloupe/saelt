...
class FillPermissionsForTrancheSaison extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTrancheSaison constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tranche-saison',
            'admin.tranche-saison.index',
            'admin.tranche-saison.create',
            'admin.tranche-saison.show',
            'admin.tranche-saison.edit',
            'admin.tranche-saison.delete',
            'admin.tranche-saison.bulk-delete',
        ]);
