...
class FillPermissionsForRestrictionTrajetVehicule extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForRestrictionTrajetVehicule constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.restriction-trajet-vehicule',
            'admin.restriction-trajet-vehicule.index',
            'admin.restriction-trajet-vehicule.create',
            'admin.restriction-trajet-vehicule.show',
            'admin.restriction-trajet-vehicule.edit',
            'admin.restriction-trajet-vehicule.delete',
            'admin.restriction-trajet-vehicule.bulk-delete',
        ]);
