...
class FillPermissionsForMarqueVehicule extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMarqueVehicule constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.marque-vehicule',
            'admin.marque-vehicule.index',
            'admin.marque-vehicule.create',
            'admin.marque-vehicule.show',
            'admin.marque-vehicule.edit',
            'admin.marque-vehicule.delete',
            'admin.marque-vehicule.bulk-delete',
        ]);
