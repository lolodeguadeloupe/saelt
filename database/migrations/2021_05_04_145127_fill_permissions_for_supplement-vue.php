...
class FillPermissionsForSupplementVue extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSupplementVue constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.supplement-vue',
            'admin.supplement-vue.index',
            'admin.supplement-vue.create',
            'admin.supplement-vue.show',
            'admin.supplement-vue.edit',
            'admin.supplement-vue.delete',
            'admin.supplement-vue.bulk-delete',
        ]);
