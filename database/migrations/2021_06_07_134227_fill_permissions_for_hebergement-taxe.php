...
class FillPermissionsForHebergementTaxe extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHebergementTaxe constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.hebergement-taxe',
            'admin.hebergement-taxe.index',
            'admin.hebergement-taxe.create',
            'admin.hebergement-taxe.show',
            'admin.hebergement-taxe.edit',
            'admin.hebergement-taxe.delete',
            'admin.hebergement-taxe.bulk-delete',
        ]);
