...
class FillPermissionsForModeleVehicule extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForModeleVehicule constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.modele-vehicule',
            'admin.modele-vehicule.index',
            'admin.modele-vehicule.create',
            'admin.modele-vehicule.show',
            'admin.modele-vehicule.edit',
            'admin.modele-vehicule.delete',
            'admin.modele-vehicule.bulk-delete',
        ]);
