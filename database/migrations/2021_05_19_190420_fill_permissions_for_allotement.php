...
class FillPermissionsForAllotement extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAllotement constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.allotement',
            'admin.allotement.index',
            'admin.allotement.create',
            'admin.allotement.show',
            'admin.allotement.edit',
            'admin.allotement.delete',
            'admin.allotement.bulk-delete',
        ]);
