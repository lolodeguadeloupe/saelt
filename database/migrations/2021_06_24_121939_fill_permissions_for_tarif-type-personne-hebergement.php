...
class FillPermissionsForTarifTypePersonneHebergement extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTarifTypePersonneHebergement constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tarif-type-personne-hebergement',
            'admin.tarif-type-personne-hebergement.index',
            'admin.tarif-type-personne-hebergement.create',
            'admin.tarif-type-personne-hebergement.show',
            'admin.tarif-type-personne-hebergement.edit',
            'admin.tarif-type-personne-hebergement.delete',
            'admin.tarif-type-personne-hebergement.bulk-delete',
        ]);
