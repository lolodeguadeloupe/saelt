...
class FillPermissionsForTarifBilleterieMaritime extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTarifBilleterieMaritime constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tarif-billeterie-maritime',
            'admin.tarif-billeterie-maritime.index',
            'admin.tarif-billeterie-maritime.create',
            'admin.tarif-billeterie-maritime.show',
            'admin.tarif-billeterie-maritime.edit',
            'admin.tarif-billeterie-maritime.delete',
            'admin.tarif-billeterie-maritime.bulk-delete',
        ]);
