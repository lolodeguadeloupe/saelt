...
class FillPermissionsForServiceTransport extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForServiceTransport constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.service-transport',
            'admin.service-transport.index',
            'admin.service-transport.create',
            'admin.service-transport.show',
            'admin.service-transport.edit',
            'admin.service-transport.delete',
            'admin.service-transport.bulk-delete',
        ]);
