...
class FillPermissionsForLigneCommandeSupplement extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLigneCommandeSupplement constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ligne-commande-supplement',
            'admin.ligne-commande-supplement.index',
            'admin.ligne-commande-supplement.create',
            'admin.ligne-commande-supplement.show',
            'admin.ligne-commande-supplement.edit',
            'admin.ligne-commande-supplement.delete',
            'admin.ligne-commande-supplement.bulk-delete',
        ]);
