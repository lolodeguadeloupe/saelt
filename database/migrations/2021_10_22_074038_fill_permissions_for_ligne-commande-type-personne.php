...
class FillPermissionsForLigneCommandeTypePersonne extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLigneCommandeTypePersonne constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ligne-commande-type-personne',
            'admin.ligne-commande-type-personne.index',
            'admin.ligne-commande-type-personne.create',
            'admin.ligne-commande-type-personne.show',
            'admin.ligne-commande-type-personne.edit',
            'admin.ligne-commande-type-personne.delete',
            'admin.ligne-commande-type-personne.bulk-delete',
        ]);
