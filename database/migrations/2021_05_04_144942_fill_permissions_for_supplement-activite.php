...
class FillPermissionsForSupplementActivite extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSupplementActivite constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.supplement-activite',
            'admin.supplement-activite.index',
            'admin.supplement-activite.create',
            'admin.supplement-activite.show',
            'admin.supplement-activite.edit',
            'admin.supplement-activite.delete',
            'admin.supplement-activite.bulk-delete',
        ]);
