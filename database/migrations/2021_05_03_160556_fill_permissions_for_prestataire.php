...
class FillPermissionsForPrestataire extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPrestataire constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.prestataire',
            'admin.prestataire.index',
            'admin.prestataire.create',
            'admin.prestataire.show',
            'admin.prestataire.edit',
            'admin.prestataire.delete',
            'admin.prestataire.bulk-delete',
        ]);
