...
class FillPermissionsForLigneCommandeBilletterie extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLigneCommandeBilletterie constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ligne-commande-billetterie',
            'admin.ligne-commande-billetterie.index',
            'admin.ligne-commande-billetterie.create',
            'admin.ligne-commande-billetterie.show',
            'admin.ligne-commande-billetterie.edit',
            'admin.ligne-commande-billetterie.delete',
            'admin.ligne-commande-billetterie.bulk-delete',
        ]);
