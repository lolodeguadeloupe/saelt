...
class FillPermissionsForTypeChambre extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTypeChambre constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.type-chambre',
            'admin.type-chambre.index',
            'admin.type-chambre.create',
            'admin.type-chambre.show',
            'admin.type-chambre.edit',
            'admin.type-chambre.delete',
            'admin.type-chambre.bulk-delete',
        ]);
