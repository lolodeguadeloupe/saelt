...
class FillPermissionsForSupplementExcursion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSupplementExcursion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.supplement-excursion',
            'admin.supplement-excursion.index',
            'admin.supplement-excursion.create',
            'admin.supplement-excursion.show',
            'admin.supplement-excursion.edit',
            'admin.supplement-excursion.delete',
            'admin.supplement-excursion.bulk-delete',
        ]);
