...
class FillPermissionsForcompagnieTransport extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForcompagnieTransport constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.compagnie-transport',
            'admin.compagnie-transport.index',
             'admin.compagnie-transport.all',
            'admin.compagnie-transport.maritime',
             'admin.compagnie-transport.aerien',
            'admin.compagnie-transport.create',
            'admin.compagnie-transport.show',
            'admin.compagnie-transport.edit',
            'admin.compagnie-transport.delete',
            'admin.compagnie-transport.bulk-delete',
        ]);
