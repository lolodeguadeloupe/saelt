...
class FillPermissionsForPlaningTime extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPlaningTime constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.planing-time',
            'admin.planing-time.index',
            'admin.planing-time.create',
            'admin.planing-time.show',
            'admin.planing-time.edit',
            'admin.planing-time.delete',
            'admin.planing-time.bulk-delete',
        ]);
