...
class FillPermissionsForTranchePersonneTransfertVoyage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTranchePersonneTransfertVoyage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tranche-personne-transfert-voyage',
            'admin.tranche-personne-transfert-voyage.index',
            'admin.tranche-personne-transfert-voyage.create',
            'admin.tranche-personne-transfert-voyage.show',
            'admin.tranche-personne-transfert-voyage.edit',
            'admin.tranche-personne-transfert-voyage.delete',
            'admin.tranche-personne-transfert-voyage.bulk-delete',
        ]);
