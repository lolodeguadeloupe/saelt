...
class FillPermissionsForLocationVehiculeSaison extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLocationVehiculeSaison constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.location-vehicule-saison',
            'admin.location-vehicule-saison.index',
            'admin.location-vehicule-saison.create',
            'admin.location-vehicule-saison.show',
            'admin.location-vehicule-saison.edit',
            'admin.location-vehicule-saison.delete',
            'admin.location-vehicule-saison.bulk-delete',
        ]);
