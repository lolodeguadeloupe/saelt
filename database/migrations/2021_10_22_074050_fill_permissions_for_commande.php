...
class FillPermissionsForCommande extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCommande constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.commande.create',
            'admin.commande.show',
            'admin.commande.edit',
            'admin.commande.delete',
            'admin.commande.bulk-delete',
        ]);
