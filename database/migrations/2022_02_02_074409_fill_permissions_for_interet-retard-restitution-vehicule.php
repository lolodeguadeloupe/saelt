...
class FillPermissionsForInteretRetardRestitutionVehicule extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForInteretRetardRestitutionVehicule constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.interet-retard-restitution-vehicule',
            'admin.interet-retard-restitution-vehicule.index',
            'admin.interet-retard-restitution-vehicule.create',
            'admin.interet-retard-restitution-vehicule.show',
            'admin.interet-retard-restitution-vehicule.edit',
            'admin.interet-retard-restitution-vehicule.delete',
            'admin.interet-retard-restitution-vehicule.bulk-delete',
        ]);
