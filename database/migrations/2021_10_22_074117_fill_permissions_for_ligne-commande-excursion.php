...
class FillPermissionsForLigneCommandeExcursion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLigneCommandeExcursion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ligne-commande-excursion',
            'admin.ligne-commande-excursion.index',
            'admin.ligne-commande-excursion.create',
            'admin.ligne-commande-excursion.show',
            'admin.ligne-commande-excursion.edit',
            'admin.ligne-commande-excursion.delete',
            'admin.ligne-commande-excursion.bulk-delete',
        ]);
