...
class FillPermissionsForTarifSupplementActivite extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTarifSupplementActivite constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tarif-supplement-activite',
            'admin.tarif-supplement-activite.index',
            'admin.tarif-supplement-activite.create',
            'admin.tarif-supplement-activite.show',
            'admin.tarif-supplement-activite.edit',
            'admin.tarif-supplement-activite.delete',
            'admin.tarif-supplement-activite.bulk-delete',
        ]);
