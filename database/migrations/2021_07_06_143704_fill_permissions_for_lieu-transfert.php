...
class FillPermissionsForLieuTransfert extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLieuTransfert constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.lieu-transfert',
            'admin.lieu-transfert.index',
            'admin.lieu-transfert.create',
            'admin.lieu-transfert.show',
            'admin.lieu-transfert.edit',
            'admin.lieu-transfert.delete',
            'admin.lieu-transfert.bulk-delete',
        ]);
