...
class FillPermissionsForModePayement extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForModePayement constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.mode-payement',
            'admin.mode-payement.index',
            'admin.mode-payement.create',
            'admin.mode-payement.show',
            'admin.mode-payement.edit',
            'admin.mode-payement.delete',
            'admin.mode-payement.bulk-delete',
        ]);
