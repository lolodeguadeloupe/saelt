...
class FillPermissionsForFraisDossier extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFraisDossier constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.frais-dossier',
            'admin.frais-dossier.index',
            'admin.frais-dossier.create',
            'admin.frais-dossier.show',
            'admin.frais-dossier.edit',
            'admin.frais-dossier.delete',
            'admin.frais-dossier.bulk-delete',
        ]);
