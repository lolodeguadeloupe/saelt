...
class FillPermissionsForFacturationCommande extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFacturationCommande constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.facturation-commande',
            'admin.facturation-commande.index',
            'admin.facturation-commande.create',
            'admin.facturation-commande.show',
            'admin.facturation-commande.edit',
            'admin.facturation-commande.delete',
            'admin.facturation-commande.bulk-delete',
        ]);
