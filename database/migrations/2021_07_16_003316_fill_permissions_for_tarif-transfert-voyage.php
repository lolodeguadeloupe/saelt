...
class FillPermissionsForTarifTransfertVoyage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTarifTransfertVoyage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tarif-transfert-voyage',
            'admin.tarif-transfert-voyage.index',
            'admin.tarif-transfert-voyage.create',
            'admin.tarif-transfert-voyage.show',
            'admin.tarif-transfert-voyage.edit',
            'admin.tarif-transfert-voyage.delete',
            'admin.tarif-transfert-voyage.bulk-delete',
        ]);
