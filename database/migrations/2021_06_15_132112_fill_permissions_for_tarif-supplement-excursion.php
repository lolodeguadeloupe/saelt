...
class FillPermissionsForTarifSupplementExcursion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTarifSupplementExcursion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tarif-supplement-excursion',
            'admin.tarif-supplement-excursion.index',
            'admin.tarif-supplement-excursion.create',
            'admin.tarif-supplement-excursion.show',
            'admin.tarif-supplement-excursion.edit',
            'admin.tarif-supplement-excursion.delete',
            'admin.tarif-supplement-excursion.bulk-delete',
        ]);
