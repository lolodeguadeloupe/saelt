...
class FillPermissionsForPlaningVehicule extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForPlaningVehicule constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.planing-vehicule',
            'admin.planing-vehicule.index',
            'admin.planing-vehicule.create',
            'admin.planing-vehicule.show',
            'admin.planing-vehicule.edit',
            'admin.planing-vehicule.delete',
            'admin.planing-vehicule.bulk-delete',
        ]);
