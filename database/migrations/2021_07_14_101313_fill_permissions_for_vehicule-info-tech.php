...
class FillPermissionsForVehiculeInfoTech extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForVehiculeInfoTech constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.vehicule-info-tech',
            'admin.vehicule-info-tech.index',
            'admin.vehicule-info-tech.create',
            'admin.vehicule-info-tech.show',
            'admin.vehicule-info-tech.edit',
            'admin.vehicule-info-tech.delete',
            'admin.vehicule-info-tech.bulk-delete',
        ]);
