...
class FillPermissionsForTarifExcursion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTarifExcursion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tarif-excursion',
            'admin.tarif-excursion.index',
            'admin.tarif-excursion.create',
            'admin.tarif-excursion.show',
            'admin.tarif-excursion.show-tarif-saison',
            'admin.tarif-excursion.edit',
            'admin.tarif-excursion.delete',
            'admin.tarif-excursion.bulk-delete',
        ]);
