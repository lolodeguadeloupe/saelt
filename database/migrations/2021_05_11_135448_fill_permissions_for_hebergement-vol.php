...
class FillPermissionsForHebergementVol extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHebergementVol constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.hebergement-vol',
            'admin.hebergement-vol.index',
            'admin.hebergement-vol.create',
            'admin.hebergement-vol.show',
            'admin.hebergement-vol.edit',
            'admin.hebergement-vol.delete',
            'admin.hebergement-vol.bulk-delete',
        ]);
