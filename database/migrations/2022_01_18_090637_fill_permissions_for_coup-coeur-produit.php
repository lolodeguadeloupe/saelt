...
class FillPermissionsForCoupCoeurProduit extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCoupCoeurProduit constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.coup-coeur-produit',
            'admin.coup-coeur-produit.index',
            'admin.coup-coeur-produit.create',
            'admin.coup-coeur-produit.show',
            'admin.coup-coeur-produit.edit',
            'admin.coup-coeur-produit.delete',
            'admin.coup-coeur-produit.bulk-delete',
        ]);
