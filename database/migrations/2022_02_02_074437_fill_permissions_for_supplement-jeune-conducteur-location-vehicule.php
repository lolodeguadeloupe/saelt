...
class FillPermissionsForSupplementJeuneConducteurLocationVehicule extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSupplementJeuneConducteurLocationVehicule constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.supplement-jeune-conducteur-location-vehicule',
            'admin.supplement-jeune-conducteur-location-vehicule.index',
            'admin.supplement-jeune-conducteur-location-vehicule.create',
            'admin.supplement-jeune-conducteur-location-vehicule.show',
            'admin.supplement-jeune-conducteur-location-vehicule.edit',
            'admin.supplement-jeune-conducteur-location-vehicule.delete',
            'admin.supplement-jeune-conducteur-location-vehicule.bulk-delete',
        ]);
