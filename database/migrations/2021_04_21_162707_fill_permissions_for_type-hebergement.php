...
class FillPermissionsForTypeHebergement extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTypeHebergement constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.type-hebergement',
            'admin.type-hebergement.index',
            'admin.type-hebergement.create',
            'admin.type-hebergement.show',
            'admin.type-hebergement.edit',
            'admin.type-hebergement.delete',
            'admin.type-hebergement.bulk-delete',
        ]);
