...
class FillPermissionsForItineraireExcursion extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForItineraireExcursion constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.itineraire-excursion',
            'admin.itineraire-excursion.index',
            'admin.itineraire-excursion.create',
            'admin.itineraire-excursion.show',
            'admin.itineraire-excursion.edit',
            'admin.itineraire-excursion.delete',
            'admin.itineraire-excursion.bulk-delete',
        ]);
