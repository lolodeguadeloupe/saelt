...
class FillPermissionsForAppConfig extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAppConfig constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.app-config.show',
            'admin.app-config.edit',
            'admin.app-config.delete',
            'admin.app-config.bulk-delete',
        ]);
