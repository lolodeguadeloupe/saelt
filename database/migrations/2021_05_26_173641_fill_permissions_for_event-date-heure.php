...
class FillPermissionsForEventDateHeure extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEventDateHeure constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.event-date-heure',
            'admin.event-date-heure.index',
            'admin.event-date-heure.create',
            'admin.event-date-heure.show',
            'admin.event-date-heure.edit',
            'admin.event-date-heure.delete',
            'admin.event-date-heure.bulk-delete',
        ]);
