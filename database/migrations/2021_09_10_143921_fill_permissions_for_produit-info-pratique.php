...
class FillPermissionsForProduitInfoPratique extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProduitInfoPratique constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.produit-info-pratique',
            'admin.produit-info-pratique.index',
            'admin.produit-info-pratique.create',
            'admin.produit-info-pratique.show',
            'admin.produit-info-pratique.edit',
            'admin.produit-info-pratique.delete',
            'admin.produit-info-pratique.bulk-delete',
        ]);
