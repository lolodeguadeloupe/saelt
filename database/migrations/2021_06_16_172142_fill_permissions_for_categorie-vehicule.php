...
class FillPermissionsForCategorieVehicule extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCategorieVehicule constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.categorie-vehicule',
            'admin.categorie-vehicule.index',
            'admin.categorie-vehicule.create',
            'admin.categorie-vehicule.show',
            'admin.categorie-vehicule.edit',
            'admin.categorie-vehicule.delete',
            'admin.categorie-vehicule.bulk-delete',
        ]);
