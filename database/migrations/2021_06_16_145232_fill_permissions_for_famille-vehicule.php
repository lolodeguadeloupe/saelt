...
class FillPermissionsForFamilleVehicule extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFamilleVehicule constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.famille-vehicule',
            'admin.famille-vehicule.index',
            'admin.famille-vehicule.create',
            'admin.famille-vehicule.show',
            'admin.famille-vehicule.edit',
            'admin.famille-vehicule.delete',
            'admin.famille-vehicule.bulk-delete',
        ]);
