...
class FillPermissionsForTypePersonne extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTypePersonne constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.type-personne',
            'admin.type-personne.index',
            'admin.type-personne.index-prod',
            'admin.type-personne.create',
            'admin.type-personne.show',
            'admin.type-personne.edit',
            'admin.type-personne.delete',
            'admin.type-personne.bulk-delete',
        ]);
