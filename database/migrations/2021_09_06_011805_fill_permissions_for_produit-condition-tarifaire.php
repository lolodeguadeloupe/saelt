...
class FillPermissionsForProduitConditionTarifaire extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProduitConditionTarifaire constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.produit-condition-tarifaire',
            'admin.produit-condition-tarifaire.index',
            'admin.produit-condition-tarifaire.create',
            'admin.produit-condition-tarifaire.show',
            'admin.produit-condition-tarifaire.edit',
            'admin.produit-condition-tarifaire.delete',
            'admin.produit-condition-tarifaire.bulk-delete',
        ]);
