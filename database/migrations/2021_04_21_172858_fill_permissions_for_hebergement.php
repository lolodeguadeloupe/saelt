...
class FillPermissionsForHebergement extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForHebergement constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.hebergement',
            'admin.hebergement.index',
            'admin.hebergement.create',
            'admin.hebergement.create-prestataire',
            'admin.hebergement.show',
            'admin.hebergement.edit',
            'admin.hebergement.edit-prestataire',
            'admin.hebergement.delete',
            'admin.hebergement.bulk-delete',
            'admin.hebergememnts.update-prestataire'
        ]);
