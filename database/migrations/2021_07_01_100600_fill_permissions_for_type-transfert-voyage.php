...
class FillPermissionsForTypeTransfertVoyage extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTypeTransfertVoyage constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.type-transfert-voyage',
            'admin.type-transfert-voyage.index',
            'admin.type-transfert-voyage.create',
            'admin.type-transfert-voyage.show',
            'admin.type-transfert-voyage.edit',
            'admin.type-transfert-voyage.delete',
            'admin.type-transfert-voyage.bulk-delete',
        ]);
