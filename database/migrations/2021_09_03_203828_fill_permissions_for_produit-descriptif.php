...
class FillPermissionsForProduitDescriptif extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProduitDescriptif constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.produit-descriptif',
            'admin.produit-descriptif.index',
            'admin.produit-descriptif.create',
            'admin.produit-descriptif.show',
            'admin.produit-descriptif.edit',
            'admin.produit-descriptif.delete',
            'admin.produit-descriptif.bulk-delete',
        ]);
