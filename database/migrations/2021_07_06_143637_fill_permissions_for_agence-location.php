...
class FillPermissionsForAgenceLocation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAgenceLocation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.agence-location',
            'admin.agence-location.index',
            'admin.agence-location.create',
            'admin.agence-location.show',
            'admin.agence-location.edit',
            'admin.agence-location.delete',
            'admin.agence-location.bulk-delete',
        ]);
