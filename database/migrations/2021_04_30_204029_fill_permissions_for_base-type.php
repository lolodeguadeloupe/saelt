...
class FillPermissionsForBaseType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBaseType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.base-type',
            'admin.base-type.index',
            'admin.base-type.create',
            'admin.base-type.show',
            'admin.base-type.edit',
            'admin.base-type.delete',
            'admin.base-type.bulk-delete',
        ]);
