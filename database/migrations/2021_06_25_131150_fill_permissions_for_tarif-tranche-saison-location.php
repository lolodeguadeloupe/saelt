...
class FillPermissionsForTarifTrancheSaisonLocation extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTarifTrancheSaisonLocation constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tarif-tranche-saison-location',
            'admin.tarif-tranche-saison-location.index',
            'admin.tarif-tranche-saison-location.create',
            'admin.tarif-tranche-saison-location.show',
            'admin.tarif-tranche-saison-location.edit',
            'admin.tarif-tranche-saison-location.delete',
            'admin.tarif-tranche-saison-location.bulk-delete',
        ]);
