...
class FillPermissionsForLigneCommandeTransfert extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLigneCommandeTransfert constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.ligne-commande-transfert',
            'admin.ligne-commande-transfert.index',
            'admin.ligne-commande-transfert.create',
            'admin.ligne-commande-transfert.show',
            'admin.ligne-commande-transfert.edit',
            'admin.ligne-commande-transfert.delete',
            'admin.ligne-commande-transfert.bulk-delete',
        ]);
