    ...
    */
    ...
    protected function sendResetResponse(Request $request, $response)
    {
        ...
        if ($response === Password::PASSWORD_RESET) {
            $message = trans('auth-admin.passwords.reset');
        }
    ...
    protected function sendResetFailedResponse(Request $request, $response)
    {
        ...
        if ($response === Password::INVALID_TOKEN) {
            $message = trans('auth-admin.passwords.invalid_token');
        } else {
            if ($response === Password::INVALID_USER) {
                $message = trans('auth-admin.passwords.invalid_user');
            } else {
                if ($response === Password::INVALID_PASSWORD) {
                    $message = trans('auth-admin.passwords.invalid_password');
                }
            }
        }
