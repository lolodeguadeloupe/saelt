...
class UpdatePrestataire extends FormRequest {
    ...
    public function authorize(): bool {
        return Gate::allows('admin.prestataire.edit', $this->prestataire);
    }
    ...
    public function rules(): array {
        return [
            'name' => ['sometimes', 'string', 'unique:prestataire,name,' . $this->prestataire->id],
