...
class UpdateServicePort extends FormRequest {
    ...
    public function authorize(): bool {
        return Gate::allows('admin.service-port.edit', $this->servicePort);
    }
    ...
    public function rules(): array {
        return [
            'code_service' => ['sometimes', Rule::unique('service_port', 'code_service')->ignore($this->servicePort->getKey(), $this->servicePort->getKeyName()), 'string'],
