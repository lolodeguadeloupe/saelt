...
class StoreTarifExcursion extends FormRequest {
    ...
    public function authorize(): bool {
        return Gate::allows('admin.tarif-excursion.create') ;
    }
    ...
    public function rules(): array {
        return [
            ...
            'saison_id' => ['required', 'string', Rule::unique('tarif_excursion')->where('excursion_id', $this->excursion_id)->where('saison_id', $this->saison_id)],
            //
