...
class StoreServiceAeroport extends FormRequest {
    ...
    public function authorize(): bool {
        return Gate::allows('admin.service-aeroport.create');
    }
    ...
    public function rules(): array {
        return [
            'code_service' => ['nullable', Rule::unique('service_aeroport', 'code_service'), 'string'],
