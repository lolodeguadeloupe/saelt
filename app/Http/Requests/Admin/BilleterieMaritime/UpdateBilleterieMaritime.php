...
class UpdateBilleterieMaritime extends FormRequest
{
    ...
    {
        return Gate::allows('admin.billeterie-maritime.edit', $this->billeterieMaritime);
    }
    ...
    public function rules(): array
    {
        ...
        return [
            'parcours' => ['sometimes', 'string'],
            'availability' => ['nullable', 'string'],
            'titre' => ['sometimes', 'string', 'unique:billeterie_maritime,titre,' . $this->billeterieMaritime->id],
            ...
            'date_acquisition' => ['sometimes', 'date', 'before:now'],
