...
class StoreTrajetTransfertVoyage extends FormRequest
{
    ...
    {
        return Gate::allows('admin.trajet-transfert-voyage.create');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'point_depart' => ['required', 'string', Rule::unique('trajet_transfert_voyage', 'point_depart')->where('point_arrive', $this->point_arrive)],
            'point_arrive' => ['required', 'string', Rule::notIn([$this->point_depart])],
