...
class UpdateTarif extends FormRequest
{
    ...
    {
        return Gate::allows('admin.tarif.edit', $this->tarif);
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'type_chambre_id' => ['required', 'string', Rule::unique('tarifs','type_chambre_id')->ignore($this->tarif->getKey(), $this->tarif->getKeyName())->where(function ($query) use ($has_chambre_prix) {
