...
class StoreHebergementMarqueBlanche extends FormRequest {
    ...
    public function authorize(): bool {
        return Gate::allows('admin.hebergement-marque-blanche.create');
    }
    ...
    public function rules(): array {
        return [
            'liens' => ['required', 'string'],
            'description' => ['nullable', 'string'],
            'image' => ['nullable', 'array'],
            'image.*' => ['required', 'string'],
            'type_hebergement_id' => ['required', 'string'],
        ];
    }
