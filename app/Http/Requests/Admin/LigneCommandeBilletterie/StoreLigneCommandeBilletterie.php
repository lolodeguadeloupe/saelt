...
class StoreLigneCommandeBilletterie extends FormRequest
{
    /**
    ...
    {
        return Gate::allows('admin.ligne-commande-billetterie.create');
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'compagnie_transport_name' => ['required', 'string'],
