...
Vue.component('produit-info-pratique-listing', {
    mixins: [AppForm],
    data: function() {
        return {
            form: { info_pratique: '' },
    ...
    methods: {
        editInfo(event, url) {
            ...
            axios.get(url).then(function(response) {
                _this5.is_edit = true;
                _this5.form = { info_pratique: response.data && response.data.info_pratique ? response.data.info_pratique : "" };
            }, function(error) {
        ...
        saveInfo(event, url) {
            ...
            let loading = $(event.target).InputLoadRequest();
            axios.post(url, {
                info_pratique: _this5.form.info_pratique,
