...
Vue.component('detail-excursion-listing', {
        ...
        storeExcursion(event, modal) {
            ...
            this.mySubmit(event, {
                success: function (response) {
                    ...
                    _this5.data_detail = [{ ..._this5.data_detail[0], ...response.data.excursion, image: (response.data.excursion.image ? response.data.excursion.image : []) }];
