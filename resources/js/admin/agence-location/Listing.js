...
Vue.component('agence-location-listing', {
    ...
    methods: {
        ...
        createAgence(event, url) {
            ...
            _this5.myEvent = {
                ..._this5.myEvent,
                'createAgence': function() {
                    loading.remove()
                }
            }
            _this5.$modal.show('create_agence');
        },
        ...
        detail(id) {
            window.location.replace(`${this.url}/${id}?agence-location`);
        },
    },
    props: [
        'url',
