...
@section('title', trans('admin.tranche-saison.actions.index'))

@section('body')

<tranche-saison-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/location-vehicule-tranche-saisons') }}'" :action="'{{ url('admin/location-vehicule-tranche-saisons?location='.$vehiculeLocation->id) }}'" :location="{{$vehiculeLocation->toJson()}}" :urlbase="'{{base_url('')}}'" :urlasset="'{{asset('')}}'" inline-template>
            ...
            <div class="col-10 content-_nav">
                <div class="card position-relative">
                    <div class="card-header">
                        ...
                        <h3>{{ trans('admin.tranche-saison.actions.index') }}</h3>
                    </div>
                    <div class="card-body" v-cloak>
                        <div class="card-block position-relative">
                            ...
                            <form id="tranche-saisonnalite" method="post" @submit.prevent="storeTranche($event)" :action="actionFormUrlTranche">
                                    ...
                                    <table class="table table-hover table-listing mt-5">
                                        <thead>
                                            <tr>
                                                ...
                                                <th is='sortable' :column="'id'" style="width: 15%;">{{ trans('admin.tranche-saison.columns.id') }}</th>
                                                <th style="width: 25%;" is='sortable' :column="'titre'">{{ trans('admin.tranche-saison.columns.titre') }}</th>
                                                <th style="width: 20%;" is='sortable' :column="'nombre_min'">{{ trans('admin.tranche-saison.columns.nombre_min') }}</th>
                                                <th style="width: 20%;" is='sortable' :column="'nombre_max'">{{ trans('admin.tranche-saison.columns.nombre_max') }}</th>
                                        ...
                                        <tbody>
                                            <tr v-for="(item, index) in collection" :key="item.id" :class="bulkItems[item.id] ? 'bg-bulk' : ''">
                                                ...
                                                <td :id="'liste-nombre_min-'+item.id">@{{ item.nombre_min }} jours</td>
                                                <td :id="'liste-nombre_max-'+item.id">@{{ item.nombre_max }} jours</td>

                                                <td :id="'liste-modif-'+item.id">
                                                    <div class="row no-gutters">
                                                        <div class="col-auto">
                                                            <a class="btn btn-sm btn-info" @click.prevent="editTranche($event, urlbase+'/admin/location-vehicule-tranche-saisons/' + item.id + '/edit', item.id)" href="#" title="{{ trans('admin-base.btn.edit') }}" role="button"><i class="fa fa-edit"></i></a>
                                                        </div>
                                                        <div class="col">
                                                            <button type="button" @click.prevent="deleteTranche($event,urlbase+'/admin/location-vehicule-tranche-saisons/' + item.id)" class="btn btn-sm btn-danger" title="{{ trans('admin-base.btn.delete') }}"><i class="fa fa-trash-o"></i></button>
                                                        </div>
                                                    </div>
                                                </td>
                                            </tr>
                                                ...
                                                <td>
                                                    <div style="position:absolute; top:0; left:0;width:100%;height:100%;display:flex;align-items:center;background-color:white">
                                                        <div class="form-group row align-items-center" style="margin: auto;margin-left: 0;width: 100%;">
                                                            <div class="col-12">
                                                                <input type="text" readonly class="form-control" name="id" placeholder="{{ trans('admin.tranche-saison.columns.id') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td>
                                                    <div style="position:absolute; top:0; left:0;width:100%;height:100%;display:flex;align-items:center;background-color:white">
                                                        <div class="form-group row align-items-center" style="margin: auto;margin-left: 0;width: 100%;">
                                                            ...
                                                            <div class="col-12">
                                                                <input type="text" required class="form-control" name="titre" placeholder="{{ trans('admin.tranche-saison.columns.titre') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div style="position:absolute; top:0; left:0;width:100%;height:100%;display:flex;align-items:center;background-color:white">
                                                        <div class="form-group row align-items-center" style="margin: auto;margin-left: 0;width: 100%;">
                                                            ...
                                                            <div class="col-12">
                                                                <input type="number" required class="form-control" name="nombre_min" placeholder="{{ trans('admin.tranche-saison.columns.nombre_min') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div style="position:absolute; top:0; left:0;width:100%;height:100%;display:flex;align-items:center;background-color:white">
                                                        <div class="form-group row align-items-center" style="margin: auto;margin-left: 0;width: 100%;">
                                                            ...
                                                            <div class="col-12">
                                                                <input type="number" required class="form-control" name="nombre_max" placeholder="{{ trans('admin.tranche-saison.columns.nombre_max') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr v-if="!actionForm">
                                                <td colspan="6" style="display: table-cell !important;">
                                                    <a class="btn btn-primary" href="#" @click.prevent="createTranche" role="button"><i class="fa fa-plus"></i>&nbsp; {{ trans('admin.tranche-saison.actions.create') }}</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
