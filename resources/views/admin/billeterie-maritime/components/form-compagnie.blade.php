...
<div class="form-group row align-items-center">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="time" class="form-control" name="heure_ouverture" placeholder="{{ trans('admin.compagnie-transport.columns.heure_fermeture') }}">
    </div>
</div>
...
<div class="form-group row align-items-center">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="time" class="form-control" name="heure_fermeture" placeholder="{{ trans('admin.compagnie-transport.columns.heure_fermeture') }}">
    </div>
</div>
