<div class="card">
    ...
    <div class="card-header">
        ...
        <h3>
            {{ trans('admin.billeterie-maritime.actions.create') }}
        </h3>
        <a class="float-right text-danger" style="cursor:pointer;" @click.prevent="closeModal('create_billeterie')"><i class="fa fa-times"></i></a>
    </div>
    ...
    <div class="card-body">
        ...
        <form class="form-horizontal form-create" id="create-billeterie" method="post" @submit.prevent="storeBilleterie($event,'create_billeterie')" action="{{url('admin/billeterie-maritimes')}}" novalidate>
    ...
    <div class="card-footer" v-if="billeterie_form[2]">
        <button type="button" class="btn btn-primary" @click.prevent="$modal.hide('create_billeterie')">
