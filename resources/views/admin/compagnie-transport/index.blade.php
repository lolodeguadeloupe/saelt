...
<all-compagnie-transport-listing :data="{{ $data->toJson() }}" :url="'{{ url('admin/all-compagnie-transports'.(app('request')->has('transport')? '?transport='.app('request')->input('transport'):'?all=')) }} '" :action="'{{ url('admin/compagnie-transports') }}'" :urlbase="'{{base_url('')}}'" :urlasset="'{{asset('')}}'" :typetransport="{{((app('request')->has('transport') && app('request')->input('transport') == 'Maritime')? json_encode(['Maritime']):(app('request')->has('transport')? json_encode(['Aérien']):json_encode(['Maritime','Aérien'])))}}" inline-template>
    ...
    <div style="display: contents;position:relative">
        ...
        <modal name="edit_compagnie" :min-width="320" :scrollable="true" :max-width="1000" height="auto" width="100%" :draggable="true" @opened="myEvent.editCompagnie()" :adaptive="true">
            @include('admin.compagnie-transport.edit')
        </modal>
        <modal name="create_compagnie" :min-width="320" :scrollable="true" :max-width="1000" height="auto" width="100%" :draggable="true" @opened="myEvent.createCompagnie()" :adaptive="true">
            @include('admin.compagnie-transport.create')
        </modal>
        <modal name="create_ville" :scrollable="true" :min-width="320" :max-width="600" height="auto" width="100%" :draggable="true" :adaptive="true">
            @include('admin.compagnie-transport.ville')
        </modal>

        <modal name="create_pays" :scrollable="true" :min-width="320" :max-width="500" height="auto" width="100%" :draggable="true" :adaptive="true">
            @include('admin.compagnie-transport.pays')
        </modal>
    </div>
</all-compagnie-transport-listing>
