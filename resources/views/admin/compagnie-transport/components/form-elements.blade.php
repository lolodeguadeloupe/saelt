...
<!--
<div class="form-group row align-items-center">
    <label for="code_compagnie" class="col-form-label text-md-right reauired" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.compagnie-transport.columns.code_compagnie') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" required class="form-control" name="code_compagnie" placeholder="{{ trans('admin.compagnie-transport.columns.code_compagnie') }}">
    </div>
</div>
-->

<div class="form-group row align-items-center">
    <label for="email" class="col-form-label text-md-right required" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.compagnie-transport.columns.email') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
...
<div class="form-group row align-items-center">
    <label for="phone" class="col-form-label text-md-right required" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.compagnie-transport.columns.phone') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
...
<div class="form-group row align-items-center">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <select required class="form-control" name="type_transport">
            <option v-for="transport in typetransport" :value="transport">@{{ transport }}</option>
        </select>
    </div> 
</div>
