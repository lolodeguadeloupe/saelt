        <div class="card">
            ...
            <form class="form-horizontal form-edit" id="edit-tarif" method="post" @submit.prevent="storeTarif($event,'edit_tarif')" :action="actionEditTarif" novalidate>
                ...
                <div class="card-header">
                    ...
                    <h3>{{ trans('admin.tarif-transfert-voyage.actions.edit') }}</h3>
                    ...
                    <div class="my-_header-info-table" style=" margin-bottom: 4px;background-color:#f0ecec69; padding: 25px; margin-bottom: 30px;">
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'" class="relative">
                                ...
                                <input type="text" required name="trajet_transfert_voyage_titre" readonly class="form-control" placeholder="{{ trans('admin.tarif-transfert-voyage.columns.trajet_transfert_voyage') }}">
                            </div>
                        </div>
                        <div class="form-group row align-items-center">
                            ...
                            <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'" class="relative">
                                <select name="tranche_transfert_voyage_id" class="form-control" disabled>
                                ...
                                <tbody>
                                    <tr v-for="(type_personne, _index) in typePersonnes">
                                        <td>
                                            <div class="form-group row align-items-center">
                                                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                                                    <input type="text" required class="form-control" readonly :value="type_personne.type" :name="'type_personne_type_'+type_personne.id">
                                                    <input style="display: none;" type="text" :name="'type_personne_id_'+type_personne.id" :value="type_personne.id">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group row align-items-center">
                                                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                                                    <input type="number" min="0" required class="form-control with-unite" @input="checkMarge($event,'_aller_'+type_personne.id)" :name="'prix_achat_aller_'+type_personne.id">
                                                    <span style="position: absolute; left: 20px; top: 0; width:auto; height: 100%;display: flex;align-items: center; font-weight: 500; text-decoration: underline;font-size: 18px;">€</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group row align-items-center">
                                                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                                                    <input type="number" min="0" required class="form-control with-unite" @input="checkMarge($event,'_aller_'+type_personne.id)" :name="'marge_aller_'+type_personne.id">
                                                    <span style="position: absolute; left: 20px; top: 0; width:auto; height: 100%;display: flex;align-items: center; font-weight: 500; text-decoration: underline;font-size: 18px;">€</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group row align-items-center">
                                                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                                                    <input type="number" min="0" required class="form-control with-unite" :name="'prix_vente_aller_'+type_personne.id" readonly>
                                                    <span style="position: absolute; left: 20px; top: 0; width:auto; height: 100%;display: flex;align-items: center; font-weight: 500; text-decoration: underline;font-size: 18px;">€</span>
                                                </div>
                                            </div>
                                        </td>
                                ...
                                <tbody>
                                    <tr v-for="(type_personne, _index) in typePersonnes">
                                        ...
                                        <td>
                                            <div class="form-group row align-items-center">
                                                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                                                    <input type="number" min="0" required class="form-control with-unite" @input="checkMarge($event,'_aller_retour_'+type_personne.id)" :name="'prix_achat_aller_retour_'+type_personne.id">
                                                    <span style="position: absolute; left: 20px; top: 0; width:auto; height: 100%;display: flex;align-items: center; font-weight: 500; text-decoration: underline;font-size: 18px;">€</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group row align-items-center">
                                                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                                                    <input type="number" min="0" required class="form-control with-unite" @input="checkMarge($event,'_aller_retour_'+type_personne.id)" :name="'marge_aller_retour_'+type_personne.id">
                                                    <span style="position: absolute; left: 20px; top: 0; width:auto; height: 100%;display: flex;align-items: center; font-weight: 500; text-decoration: underline;font-size: 18px;">€</span>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group row align-items-center">
                                                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                                                    <input type="number" min="0" required class="form-control with-unite" :name="'prix_vente_aller_retour_'+type_personne.id" readonly>
                                                    <span style="position: absolute; left: 20px; top: 0; width:auto; height: 100%;display: flex;align-items: center; font-weight: 500; text-decoration: underline;font-size: 18px;">€</span>
                                                </div>
                                            </div>
                                        </td>
