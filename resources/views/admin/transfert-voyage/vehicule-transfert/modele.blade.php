                <div class="card">
                    ...
                    <form class="form-horizontal form-create" id="create-modele" data-response="modeleVehicule" method="post" @submit.prevent="storeModele($event,'create_modele_vehicule')" action="{{url('admin/modele-vehicules')}}" novalidate>

                        <div class="card-header">
                            <i class="fa fa-plus"></i>
                            <h3>{{ trans('admin.modele-vehicule.actions.create') }}</h3>
                            <a class="float-right text-danger" style="cursor:pointer;" @click.prevent="closeModal('create_modele_vehicule')"><i class="fa fa-times"></i></a>
                        </div>
