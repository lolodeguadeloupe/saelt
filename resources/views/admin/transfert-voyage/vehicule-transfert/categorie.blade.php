                <div class="card">
                    ...
                    <form class="form-horizontal form-create" id="create-categorie-vehicule" method="post" @submit.prevent="storeCategorieVehicule($event,'create_categorie_vehicule')" action="{{url('admin/categorie-vehicules')}}" novalidate>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row align-items-center">
                                <label for="franchise" class="col-form-label text-md-right required" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.categorie-vehicule.columns.franchise') }}</label>
                                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                                    <input type="number" inputmode="decimal" step="any" required class="form-control with-unite" name="franchise" placeholder="{{ trans('admin.categorie-vehicule.columns.franchise') }}">
                            ...
                            <div class="form-group row align-items-center">
                                <label for="franchise_non_rachatable" class="col-form-label text-md-right required" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.categorie-vehicule.columns.franchise_non_rachatable') }}</label>
                                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                                    <input type="number" inputmode="decimal" step="any" required class="form-control with-unite" name="franchise_non_rachatable" placeholder="{{ trans('admin.categorie-vehicule.columns.franchise_non_rachatable') }}">
                                    <span style="position: absolute; left: 20px; top: 0; width:auto; height: 100%;display: flex;align-items: center; font-weight: 500; text-decoration: underline;font-size: 18px;">€</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group row align-items-center">
                                <label for="caution" class="col-form-label text-md-right required" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.categorie-vehicule.columns.caution') }}</label>
                                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                                    <input type="number" inputmode="decimal" step="any" required class="form-control with-unite" name="caution" placeholder="{{ trans('admin.categorie-vehicule.columns.caution') }}">
                                    <span style="position: absolute; left: 20px; top: 0; width:auto; height: 100%;display: flex;align-items: center; font-weight: 500; text-decoration: underline;font-size: 18px;">€</span>
                                </div>
                            </div>
