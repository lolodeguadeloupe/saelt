...
@section('title', trans('auth-admin.activation_form.title'))
                        ...
                        <auth-form
                            ...
                            <form class="form-horizontal" role="form" method="POST"
                                ...
                                <div class="auth-header">
                                    <h1 class="auth-title">{{ trans('auth-admin.activation_form.title') }}</h1>
                                    <p class="auth-subtitle">{{ trans('auth-admin.activation_form.note') }}</p>
                                </div>
                                <div class="auth-body">
                                    ...
                                    <div class="form-group"
                                        ...
                                        <div class="input-group input-group--custom">
                                            ...
                                            <input type="text" v-model="form.email" v-validate="'required|email'"
                                                   ...
                                                   id="email" name="email"
                                                   placeholder="{{ trans('auth-admin.auth_global.email') }}">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block btn-spinner"><i
                                                    class="fa"></i> {{ trans('auth-admin.activation_form.button') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
