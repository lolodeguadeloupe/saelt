...
@section('title', trans('auth-admin.password_reset.title'))
                        ...
                        <auth-form
                            ...
                            <form class="form-horizontal" role="form" method="POST"
                                ...
                                <div class="auth-header">
                                    <h1 class="auth-title">{{ trans('auth-admin.password_reset.title') }}</h1>
                                    <p class="auth-subtitle">{{ trans('auth-admin.password_reset.note') }}</p>
                                </div>
                                <div class="auth-body">
                                    ...
                                    <div class="form-group"
                                        ...
                                        <div class="input-group input-group--custom">
                                            ...
                                            <input type="password" v-model="form.password"
                                                   ...
                                                   placeholder="{{ trans('auth-admin.auth_global.password') }}"
                                                   ref="password">
                                        </div>
                                    ...
                                    <div class="form-group"
                                        ...
                                        <label for="password_confirmation">{{ trans('auth-admin.auth_global.password_confirm') }}</label>
                                        <div class="input-group input-group--custom">
                                            <div class="input-group-addon"><i class="input-icon input-icon--lock"></i>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block btn-spinner"><i
                                                    class="fa"></i> {{ trans('auth-admin.password_reset.button') }}
                                        </button>
                                    </div>
                                </div>
                            </form>
