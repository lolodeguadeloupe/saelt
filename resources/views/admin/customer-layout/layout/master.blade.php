...
<head>
    ...
    <title>@yield('title', 'Craftable')</title>

    <meta http-equiv="Cache-Control" content="no-cache, no-store, must-revalidate" />
    <meta http-equiv="Pragma" content="no-cache" />
    <meta http-equiv="Expires" content="0" />

    @include('admin.customer-layout.partials.main-styles')

    @yield('styles')

</head> 

<body class="app hold-transition sidebar-mini" style="overflow: hidden;" time-stamps="{{time()}}">
    <div class="create-page-load" style="position: absolute;width: 100%;height: 100%;top: 0;left: 0;display: flex;align-items: center;background-color: #d9e5ed;">
    ...
    <div class="wrapper opacity-load-0">
        @yield('header')
        ...
        @include('admin.customer-layout.partials.main-bottom-scripts')
