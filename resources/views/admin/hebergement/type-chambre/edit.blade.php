        <div class="card">
            ...
            <form class="form-horizontal form-edit"  id="edit-type" method="post" @submit.prevent="storeType($event,'edit_type')" :action="actionEditType" novalidate>
                ...
                <div class="card-header">
                    <i class="fa fa-pencil"></i> <h3>{{ trans('admin.type-chambre.actions.edit') }}</h3>
                    <a class="float-right text-danger" style="cursor:pointer"  href="#" @click.prevent="closeModal('edit_type')"><i class="fa fa-times"></i></a>
                </div>
