<div class="form-group row align-items-center">
    <label for="titre" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.allotement.columns.titre') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" class="form-control" name="titre" placeholder="{{ trans('admin.allotement.columns.titre') }}">
    </div>
</div>

<div class="form-group row align-items-center">
    <label for="quantite" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.allotement.columns.quantite') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="number" class="form-control" name="quantite" placeholder="{{ trans('admin.allotement.columns.quantite') }}">
    </div>
</div>
...
<div class="form-group row align-items-center">
    <label for="date_limite" class="col-form-label text-md-right required" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.allotement.columns.date_limite') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="date" required class="form-control" name="date_limite" placeholder="{{ trans('admin.allotement.columns.date_limite') }}">
    </div>
</div>
