<div class="form-group row align-items-center">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" :readonly="prestataireIsReadOnly" required class="form-control" name="name" placeholder="{{ trans('admin.prestataire.columns.name') }}" v-autocompletion="autocomplete" :action="urlbase+'/admin/autocompletion/prestataires'" :autokey="'id'" :label="'name'">
        <input type="text" required name="id" style="display: none;">
    </div>
</div>
...
<div class="form-group row align-items-center">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input type="text" :readonly="prestataireIsReadOnly" class="form-control" data-ctr="phone" name="phone" placeholder="xxx xx xx xxx xx">
    </div>
</div>
...
<div v-if="!prestataireIsReadOnly" class="form-group row align-items-center">
...
<div v-if="prestataireIsReadOnly" class="form-group row align-items-center">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'" class="relative">
        <input type="text" required name="ville_id" style="display: none;">
        <input required :readonly="prestataireIsReadOnly" type="text" name="ville_name" class="form-control" placeholder="{{ trans('admin.prestataire.columns.ville_id') }}">
    </div>
</div>
...
<div class="form-group row align-items-center">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input :readonly="prestataireIsReadOnly" type="time" class="form-control" name="heure_ouverture" placeholder="{{ trans('admin.prestataire.columns.adresse') }}">
    </div>
</div>
...
<div class="form-group row align-items-center">
    ...
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <input :readonly="prestataireIsReadOnly" type="time" class="form-control" name="heure_fermeture" placeholder="{{ trans('admin.prestataire.columns.adresse') }}">
    </div>
</div>
