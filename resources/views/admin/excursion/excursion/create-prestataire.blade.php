                <div class="card">
                    <form class="form-horizontal form-create" id="create-prestataire-autocompletion" data-response="prestataire" method="post" @submit.prevent="storePrestataire($event,'create_prestataire')" action="{{url('admin/prestataires')}}" novalidate>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                                    <input type="text" class="form-control" data-ctr="phone" name="phone" placeholder="xxx xx xx xxx xx">
                                </div>
                            </div>
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                                    <input type="text" class="form-control" data-ctr="email" name="email" placeholder="{{ trans('admin.prestataire.columns.email') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                                    <input type="text" class="form-control" data-ctr="email" name="second_email" placeholder="{{ trans('admin.prestataire.columns.second_email') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row align-items-center">
                                ...
                                <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
                                    ...
                                    <figure class="figure-form" @drop.prevent="uploadLogo($event,true)" @dragover.prevent>
