 <div class="card">
     ...
     <form class="form-horizontal form-create" id="create-supplement" method="post" @submit.prevent="storeSupplement($event,'create_supplement')" action="{{url('admin/supplement-excursions')}}" novalidate>

         <div class="card-header">
             <i class="fa fa-plus"></i>
             <h3>
                 {{ trans('admin.supplement-excursion.actions.create') }}
             </h3>
             <a class="float-right text-danger" style="cursor:pointer;" @click.prevent="closeModal('create_supplement')"><i class="fa fa-times"></i></a>
         </div>
