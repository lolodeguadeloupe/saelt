        ...
        <div class="detail-voucher p-relative table v-top border">
            <div class="voucher-col1 t-cell v-top p-relative">
                ...
                <div class="row d-block t-left v-top p-5">
                    <div class="row d-block"><span class="title">SERVICES :</span> Hébergement</div>
                    <div class="row d-block"><span class="title">DATE DEBUT HEBERGEMENT :</span> {{parse_date_string($data['date_debut'])}}</div>
                    <div class="row d-block"><span class="title">DATE FIN HEBERGEMENT :</span> {{parse_date_string($data['date_fin'])}}</div>
