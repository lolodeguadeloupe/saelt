    ...
    <div class="bloc-info p-relative">
        ...
        <div class="body-prestataire p-relative v-top table">
            ...
            <div class="info-prest-content d-relative t-cell v-top">
                <span class="value d-block v-top">{{$data['compagnie']['nom']}} </span>
                <span class="value d-block v-top">{{$data['compagnie']['adresse']}} {{$data['compagnie']['ville']['name']}} - {{$data['compagnie']['ville']['code_postal']}}</span>
                <span class="value d-block v-top">{{$data['compagnie']['phone']}}</span>
            </div>
        ...
        <div class="detail-voucher p-relative table v-top border">
            <div class="voucher-col1 t-cell v-top p-relative">
                ...
                <div class="row d-block t-left v-top p-5">
                    <div class="row d-block"><span class="title">SERVICES :</span> BILLETERIE</div>
                    <div class="row d-block"><span class="title">DATE DEPART :</span> {{parse_date_string($data['date_depart'])}} à {{date('H:i', strtotime($data['heure_aller']))}}</div>
                    @if($data['date_retour'])
                    <div class="row d-block"><span class="title">DATE RETOUR :</span> {{parse_date_string($data['date_retour'])}} à {{date('H:i', strtotime($data['heure_retour']))}}</div>
                    @endif
                    <div class="row d-block"><span class="title">LIEU DEPART :</span>{{$data['lieu_depart_name']}}</div>
                    <div class="row d-block"><span class="title">LIEU ARIVEE :</span>{{$data['lieu_arrive_name']}}</div>
