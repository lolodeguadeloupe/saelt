        ...
        <div class="detail-voucher p-relative table v-top border">
            <div class="voucher-col1 t-cell v-top p-relative">
                ...
                <div class="row d-block t-left v-top p-5">
                    ...
                    <div class="row d-block"><span class="title">DATE EXCURSION :</span> {{parse_date_string($data['date_excursion'])}} à à {{date('H:i', strtotime($data['heure_depart']))}}</div>
                    <div class="row d-block"><span class="title">LIEU DEPART :</span>{{$data['adresse_depart']}}</div>
                    <div class="row d-block"><span class="title">LIEU ARIVEE :</span>{{$data['adresse_arrive']}}</div>
