        ...
        <div class="detail-voucher p-relative table v-top border">
            <div class="voucher-col1 t-cell v-top p-relative">
                ...
                <div class="row d-block t-left v-top p-5">
                    <div class="row d-block"><span class="title">SERVICES :</span> TRANSFERT</div>
                    <div class="row d-block"><span class="title">DATE DEPART :</span> {{parse_date_string($data['date_depart'])}} à {{date('H:i', strtotime($data['heure_depart']))}}</div>
                    @if($data['date_retour'])
