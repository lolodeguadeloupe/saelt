    ...
    <div class="bloc-info p-relative">
        ...
        <div class="body-prestataire p-relative v-top table">
            ...
            <div class="info-prest-content d-relative t-cell v-top">
                <span class="value d-block v-top">{{$data['vol'][0]['compagnie_nom']}} </span>
                <span class="value d-block v-top">{{$data['vol'][0]['compagnie_adresse']}} {{$data['vol'][0]['compagnie_ville_name']}} - {{$data['vol'][0]['compagnie_ville_code_postal']}}</span>
                <span class="value d-block v-top">{{$data['vol'][0]['compagnie_phone']}}</span>
            </div>
        ...
        <div class="detail-voucher p-relative table v-top border">
            <div class="voucher-col1 t-cell v-top p-relative">
                ...
                <div class="row d-block t-left v-top p-5">
                    ...
                    <div class="row d-block"><span class="title">DATE DEPART :</span> {{parse_date_string($data['vol'][0]['depart'])}} à {{date('H:i', strtotime($data['vol'][0]['heure_depart']))}}</div>
                    <div class="row d-block"><span class="title">LIEU DEPART :</span>{{$data['vol'][0]['lieu_depart']}}</div>
                    <div class="row d-block"><span class="title">LIEU ARIVEE :</span>{{$data['vol'][0]['lieu_arrive']}}</div>
            ...
            <div class="voucher-col2 t-cell v-top p-relative border b-t-t b-b-t">
                ...
                <div class="row p-relative t-center">
                    Compagnie-{{$data['vol'][0]['compagnie_transport_id']}}
                </div>
            </div>
