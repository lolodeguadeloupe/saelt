    ...
    <div class="bloc-info p-relative">
        ...
        <div class="body-prestataire p-relative v-top table">
            ...
            <div class="info-prest-content d-relative t-cell v-top">
                <span class="value d-block v-top">{{$supplement['prestataire_name']}} </span>
                <span class="value d-block v-top">{{$supplement['prestataire_adresse']}} {{$supplement['prestataire_ville']}} - {{$supplement['prestataire_code_postal']}}</span>
                <span class="value d-block v-top">{{$supplement['prestataire_phone']}}</span>
            </div>
            <div class="info-prest-history d-relative t-cell v-top">
                ...
                <p><span class="title">Date d'émission :</span><br> {{parse_date_string(date('Y-m-d'))}}</p>
                    ...
                    <p><span class="title">Voucher n° :</span> {{$supplement['id']}}</p>
                </div>
            </div>
        </div>
        ...
        <div class="detail-voucher p-relative table v-top border">
            <div class="voucher-col1 t-cell v-top p-relative">
                ...
                <div class="row d-block t-left v-top p-5">
                    <div class="row d-block"><span class="title">SERVICES :</span> {{ $supplement['titre'] }}</div>
                    <div class="row d-block"><span class="title">DATE DEBUT :</span> {{parse_date_string($event['debut'])}}</div>
                    <div class="row d-block"><span class="title">DATE FIN :</span> {{parse_date_string($event['fin'])}}</div>
                   <div class="row d-block"><span class="title">LIEU :</span>{{$event['lieu']['name']}}</div>
            ...
            <div class="voucher-col2 t-cell v-top p-relative border b-t-t b-b-t">
                ...
                <div class="row p-relative t-center">
                    prestataire-{{$supplement['prestataire_id']}}
                </div>
            </div>
