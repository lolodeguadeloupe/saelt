    ...
    <div class="bloc-info p-relative">
        ...
        <div class="body-prestataire p-relative v-top table">
            ...
            <div class="info-prest-content d-relative t-cell v-top">
                <span class="value d-block v-top">{{$data['prestataire']['prestataire_name']}} </span>
                <span class="value d-block v-top">{{$data['prestataire']['prestataire_adresse']}} {{$data['prestataire']['prestataire_ville']}} - {{$data['prestataire']['prestataire_code_postal']}}</span>
                <span class="value d-block v-top">{{$data['prestataire']['prestataire_phone']}}</span>
            </div>
            <div class="info-prest-history d-relative t-cell v-top">
                <div class="row">
                    ...
                    <p><span class="title">Voucher n° :</span> {{$data['prestataire']['id']}}</p>
                </div>
            </div>
        </div>
        ...
        <div class="detail-voucher p-relative table v-top border">
            <div class="voucher-col1 t-cell v-top p-relative">
                ...
                <div class="row d-block t-left v-top p-5">
                    <div class="row d-block"><span class="title">SERVICES :</span> {{ trans('admin.excursion.columns.options_included.lunch') }}</div>
                    <div class="row d-block"><span class="title">DATE :</span> {{parse_date_string($data['date_excursion'])}}</div>
                   <div class="row d-block"><span class="title">LIEU :</span>{{$data['adresse_arrive']}}</div>
            ...
            <div class="voucher-col2 t-cell v-top p-relative border b-t-t b-b-t">
                ...
                <div class="row p-relative t-center">
                    prestataire-{{$data['prestataire']['prestataire_id']}}
                </div>
            </div>
